...
class ScrobbleImporterTest < ActiveSupport::TestCase
  ...
  test "Importing scrobbles are created" do
    ...
    scrobble_data = [
      ...
      ['2015-03-08T14:17:00+00:00', 1425824220, 'wildest dreams', '598bc2a9-1a27-4f6a-a7cc-30649303edca', 'TAYLOR SWIFT', '20244d07-534f-4eff-b4d4-930878889970', '', '', '', '', '1989 (Deluxe)', '', '', 'spotify'],
    ]
